    ...
    <div className="w-full h-screen bg-gradient-to-b from-gray-800
     to-black text-white">
      ...
      <p className="text-xl ">
        ...
        ratione veniam debitis autem repellat vel, aliquam eveniet tempore iusto
        cumque obcaecati distinctio velit provident ab excepturi, tenetur
        voluptatibus aut! Quasi quia quis assumenda modi, facere aliquam nostrum
        doloremque inventore quos eum ipsam non explicabo fuga iusto perferendis
